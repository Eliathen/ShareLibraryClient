...
//        val userId = 1L
//        val api = mockk<Api> {
//            coEvery { assignBook(AssignBookRequest.mock()) } returns UserResponse.mock()
//        }
//        val errorWrapper = mockk<ErrorWrapper>(relaxed = true)
//        val repository = UserRepositoryImpl(api, errorWrapper)
//        //when
//        runBlocking {
//            repository.assignBook(AssignBookRequest.mock())
//        }
//        //then
//        coVerify {
//            api.assignBook(AssignBookRequest.mock())
//        }
//    }
//    @Test
...
//        //given
//        val api = mockk<Api> {
//            coEvery { withdrawBook(WithdrawBookRequest.mock()) } returns UserResponse.mock()
//        }
//        val errorWrapper = mockk<ErrorWrapper>(relaxed = true)
//        val repository = UserRepositoryImpl(api, errorWrapper)
//        //when
//        runBlocking {
//            repository.withdrawBook(WithdrawBookRequest.mock())
//        }
//        //then
//        coVerify {
//            api.withdrawBook(WithdrawBookRequest.mock())
//        }
//    }
